...
import { getComments, getorders } from "../../API/ndex";
function AppHeader(){
    ...
    <Image
        width={40}
        src="/inventory-filled-outline-icon-design-illustration-manufacturing-units-symbol-on-white-background-eps-10-file-vector.jpg"
    ></Image>
